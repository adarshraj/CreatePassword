...
32 bitowa checksuma. Zaincluduj ten plik i wywolaj funkcje CRC32.
Parametry to ilosc bajtow danych do sprawdzenia i wskaznik do tych danych.
Wynik przekazywany jest w rejestrze eax.

np.
	push	offset _nasze_dane_o_dlugosci_451_bajtow
	push	451
	call	CRC32
